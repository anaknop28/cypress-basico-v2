...
describe('Central de Atendimento ao Cliente TAT', function() {
    ...
    it('preenche e limpa os campos nome, sobrenome, email e telefone', function() {
        ...
        cy.get('#lastName').type('Knop').should('have.value', 'Knop').clear().should('have.value', '')
        cy.get('#email').type('ana@teste.com').should('have.value', 'ana@teste.com').clear().should('have.value', '')
        cy.get('#phone').type('12345678').should('have.value', '12345678').clear().should('have.value', '')
    })

    it('exibe mensagem de erro ao submeter o formulário sem preecnher os campos obrigatórios', function() {
        cy.contains('button', 'Enviar').click()
    ...
    it('envia o formulário com sucesso usando um comando customizado', function() {
        cy.fillMandatoryFiedlsAndSubmit()
    ...
    it('verifica que a política de privacidade removendo o target e então clicando no link', function() {
